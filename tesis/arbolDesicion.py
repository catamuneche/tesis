...
arbol.fit(X_train, Y_train) #Función para entrenar el modelo
predicciones = arbol.predict(X_test)#Función para hacer las predicciones
...
confusion_matrix(Y_test,predicciones) #Matriz de confusion
